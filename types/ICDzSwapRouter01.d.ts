...
interface ICDzSwapRouter01Interface extends ethers.utils.Interface {
  functions: {
...
export class ICDzSwapRouter01 extends BaseContract {
  ...
  interface: ICDzSwapRouter01Interface;
