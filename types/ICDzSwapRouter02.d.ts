...
interface ICDzSwapRouter02Interface extends ethers.utils.Interface {
  functions: {
...
export class ICDzSwapRouter02 extends BaseContract {
  ...
  interface: ICDzSwapRouter02Interface;
